...
| Scholarship | `ScholarshipCycles` public CMS collection plus a future approved Wix Form/CRM workflow | Query the approved cycle at build time; show status, dates, award terms, eligibility, materials, and guarded application handoff | Public content collection is connected. Keep applicant submissions private; confirm form destination, upload/signature accessibility, privacy/retention, consent, confirmation, and next-cycle ownership |
